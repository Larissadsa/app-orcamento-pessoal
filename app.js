...
function cadastrarDespesa() {
	...
	if(despesa.validarDados()) {
		...
		document.getElementById('modal_texto').innerHTML = 'Sua despesa foi cadastrada com sucesso'
		...
		//erro
		document.getElementById('modal_titulo').innerHTML = 'Falha no registro'
		document.getElementById('modal_texto').innerHTML = 'Alguns campos obrigatórios não foram preenchidos'
